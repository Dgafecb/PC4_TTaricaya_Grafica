...
async def main():
    ...
    while running:
        ...
        for event in events:
            ...
            if event.type == pygame.QUIT:
                ...
                if estado_actual in [ESTADOS["menu"]]:
                    # Si se ha hecho click en instrucciones-> dibujar instrucciones
                    pass
        ...
        if estado_actual in [ESTADOS["menu"]]:
            ...
            # Llamar a la función para dibujar el menú y manejar la interacción
            mostrar_instrucciones = dibujar_menu(screen, TEMP, clock, events)
